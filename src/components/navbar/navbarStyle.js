...
background-color: ${props=>props.isMobile ? 'rgba(28,28,105)':'inherit'};
position:absolute ;
top:50px ;
right:0;
z-index:3;
&>li{
  border-bottom: ${props=>props.isMobile ? '2px solid rgb(28,28,105)':'2px solid white'};
}
${laptop({width:'100%',position:'static',display:'flex',justifyContent:'space-evenly',height:'60px',top:'0'})}
${tablet({width:'100%',position:'static',display:'flex',justifyContent:'center',gap:'20px',height:'60px',top:'0',fontSize:'18px',color:'gray'})}
`
